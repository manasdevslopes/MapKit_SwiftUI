...
class Destination {
  ...
  @Relationship(deleteRule: .cascade) // When Destination is deleted so all of its placemarks should also be deleted.
  var placemarks: [MTPlacemark] = [] // One-to-Many
...
extension Destination {
  ...
  static var preview: ModelContainer {
    ...
    let paris = Destination(name: "Paris", latitude: 48.856788, longitude: 2.351077, latitudeDelta: 0.15, longitudeDelta: 0.15)
